...
export const Dialog = ({ open, onOpenChange, title, children, footer }: DialogProps) => (
  <BaseDialog.Root open={open} onOpenChange={onOpenChange}>
    <BaseDialog.Portal>
      ...
      <BaseDialog.Popup className="fixed top-1/2 left-1/2 z-50 w-[min(92vw,420px)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-[var(--met-border)] bg-[var(--met-bg-elevated)] p-5 text-[var(--met-fg)] shadow-2xl outline-none">
