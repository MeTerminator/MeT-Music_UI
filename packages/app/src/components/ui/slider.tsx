...
export const Slider = ({
  ...
  >
    {/* 左右内边距 = 半个圆钮宽:thumb 中心对齐 track 端点,0%/100% 时
        圆钮的另一半会溢出 track,预留空间防压到两侧文字 */}
    <BaseSlider.Control className="flex h-4 w-full cursor-pointer items-center px-[7px] py-1">
