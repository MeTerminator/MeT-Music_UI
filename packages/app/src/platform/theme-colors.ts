/**
 * 主题色预设(取自旧 src/assets/themeColor.json,10 色,值一字未改)。
 * key 与 settings.themeTypeName / setting/options.ts 的 themeColorOptions 对应。
 */
...
export const themeColorPresets: Record<string, ThemeColorPreset> = {
  red: {
    name: "欢快派对",
    label: "red",
    primaryColor: "#fe7971",
